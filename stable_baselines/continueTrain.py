...
if __name__ == "__main__":
    ...
    model = PPO.load('sb3model/HumanoidCustomEnv-v0/2e7_ppo_steps_t0_cpu10_ppo_HumanoidCustomEnv-v0.zip',
                     env = env,
                     tensorboard_log ='tensorboard_log/HumanoidCustomEnv-v0/2e7_ppo_steps_t0_cpu10_ppo_HumanoidCustomEnv-v0' )
    try:
